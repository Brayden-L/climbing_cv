...
##
# Run utility bools
project_name = "climb_classifier_rear_glory_topo_custom_cnn_sweep"
wandb_enabled = True
...
parameters_dict = {
    ...
    'basic_lr': {
        'values': np.logspace(-7, -1, 7).tolist()
    },
    'lr_schedule': {
        'values': ['none']
    },
...
sweep_id = wandb.sweep(sweep_config, entity='braydenmlevy', project=project_name)
